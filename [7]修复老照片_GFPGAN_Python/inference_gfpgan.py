...
def main():
    ...
    parser.add_argument('--upscale', type=int, default=4, help='The final upsampling scale of the image')
    ...
    parser.add_argument('--model_path', type=str, default='https://github.com/TencentARC/GFPGAN/releases/download/v0.2.0/GFPGANCleanv1-NoCE-C2.pth')
    ...
    parser.add_argument('--test_path', type=str, default='test/whole_imgs', help='Input folder')
    ...
    for img_path in img_list:
        ...
        for idx, (cropped_face, restored_face) in enumerate(zip(cropped_faces, restored_faces)):
            ...
            cv2.imshow(f'{basename}_{idx:02d}.png', cmp_img)
            cv2.waitKey(1)
        ...
        if restored_img is not None:
            ...
            restored_img_small = cv2.resize(restored_img, (int(input_img.shape[1]), int(input_img.shape[0])))
            cv2.imshow(save_restore_path, restored_img_small)
        cv2.waitKey()
